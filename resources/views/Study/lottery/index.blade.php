...
<html>
	...
	<head>
		...
		<!-- 网站的ico图标 -->
		<link rel="shortcut icon" href="/images/img/favicon.jpg" type="image/x-icon">
...
<![endif]-->
	...
	<body>
		...
		<section class="zadan">
			<div class="zd_logo">
				<img src="/images/img/160615zadan/zd_cion03.png">
			</div>
			<div class="zd_middle">
				<div class="zd_title">
					<img src="/images/img/160615zadan/zd_cion04.png">
				</div>
				<div class="zd_zadan">
					<div class="zd_bg">
						<img src="/images/img/160615zadan/zd_cion18.png"  class="zd_bg01">
						<img src="/images/img/160615zadan/zd_cion18.png"  class="zd_bg02">
					</div>
					<div class="zd_jindan ">
						<img src="/images/img/160615zadan/zd_cion16.png">
					</div>
					<ul class="zd_bigcaidai">
						<li class="cardai01 cardai">
							<img src="/images/img/160615zadan/zd_cion15.png">
						</li>
						<li class="cardai02 cardai">
							<img src="/images/img/160615zadan/zd_cion14.png">
						</li>
						<li class="cardai03 cardai">
							<img src="/images/img/160615zadan/zd_cion13.png">
						</li>
						<li class="cardai04 cardai">
							<img src="/images/img/160615zadan/zd_cion12.png">
						</li>
						<li class="cardai05 cardai">
							<img src="/images/img/160615zadan/zd_cion11.png">
						</li>
						<li class="cardai06 cardai">
							<img src="/images/img/160615zadan/zd_cion10.png">
						</li>
					</ul>
					<div class="zd_chuizi">
						<img src="/images/img/160615zadan/zd_cion01.png">
					</div>
					<div class="zd_txt">
						<input type="text" id="iphone1" placeholder="请输入手机号" />
						<a href="javascript:;" id="submit" class="mom_btn tc">
							<img src="/images/img/160615zadan/zd_cion07.png">
						</a>
			...
			<div class="zd_bottom">
				<img src="/images/img/160615zadan/zd_cion08.png">
			</div>
