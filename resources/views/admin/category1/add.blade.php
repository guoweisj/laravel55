        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio"><label><input type="radio" name="is_super" value="1" checked> 可用</label></div>
                        <div class="radio"><label><input type="radio" name="is_super" value="2" >禁用</label></div>
                    </div>
                </div>
